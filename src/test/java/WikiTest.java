...
public class WikiTest {
    ...
    public void testWikiExample() {
        ...
        Assert.assertEquals(schulze.getWinners().toString(),
                (new LinkedHashSet<String>(Arrays.asList("E", "A", "C", "B", "D"))).toString());
    }
    ...
    public void testWikiExampleSecond() {
        ...
        Assert.assertEquals(schulze.getWinners().toString(),
                new LinkedHashSet<String>(Arrays.asList("D", "A", "C", "B")).toString());
    }
    ...
    public void testWikiExampleSecond_Loop() {
        ...
        Assert.assertEquals(schulze.getWinners().toString(),
                new LinkedHashSet<String>(Arrays.asList("B", "C", "A", "E", "D", "I", "G", "H")).toString());
    }
    ...
    public void testWikiExampleNameProject8() {
        ...
        Assert.assertEquals(schulze.getWinners().toString(), new LinkedHashSet<String>(
                Arrays.asList("Flick", "Glass-X", "Cruze", "Dark-Hive", "Delta", "Dot-Luv", "Eggplant", "Excite-Bike")).toString());
    }
